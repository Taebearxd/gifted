...
global.caption = "✿ 𝅼  𝓨𝗈𝗎  𝗌𝖺𝗂𝖽  𝗒𝗈𝗎  𝗅𝗈𝗏𝖾𝖽  𝗆𝖾,  𝖻𝗎𝗍  𝗐𝗁𝗒  𝗁𝖺𝗏𝖾  𝗂  𝗇𝖾𝗏𝖾𝗋  𝖿𝖾𝗅𝗍  𝗍𝗁𝖺𝗍  𝗅𝗈𝗏𝖾 ?"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙽𝙾𝙸𝚁*"; // Input Yours custom...(Maintain font for Flow)
 
module.exports = {
SESSION_ID: process.env.SESSION_ID || "", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "917439317360", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
AUTO_LIKE_STATUS: process.env.AUTO_LIKE_STATUS || "true",
AUTO_LIKE_EMOJI: process.env.AUTO_LIKE_EMOJI || "💜", //Input Yours custom...
AUTO_REPLY_STATUS: process.env.AUTO_REPLY_STATUS || "false",
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "✅️ Status Viewed by Noir!", // // Input Yours custom...
MODE: process.env.MODE || "public", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "917439317360", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "⎯⎯ּ︭   🧸̼᪲ 𝕹̸𑄜᳟ὶ𝗋ֺ  ❜❜ ᪶", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "⎯⎯ּ︭   🧸̼᪲ 𝕹̸𑄜᳟ὶ𝗋ֺ  ❜❜ ᪶", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "𝐃𝐎𝐍𝐓 𝐂𝐎𝐏𝐘 𝐌𝐘 𝐅𝐋𝐎𝐖 ‼️", // Added // Input Yours custom...
